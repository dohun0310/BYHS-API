...
export const fetchTimetable = async (res: Response, grade: string, classNumber: string, startDate: string, endDate: string) => {
  try {
...
export const fetchMeal = async (res: Response, startDate: string, endDate: string) => {
  try {
